...
const cart = () => {
  ...
  return (
    <div className="flex items-center justify-center">
      ...
      <div className="flex flex-col w-[92vw] p-6 space-y-4 sm:p-10">
                        ...
                        <div className="flex justify-between w-full pb-2 space-x-2">
                          <div className="space-y-1">
                            ...
                            <p className="flex items-center gap-2">
                              <button
                                className="font-sm bg-orange-400 text-white px-4 py-2"
                                onClick={() => {
                              ...
                              <button
                                className="font-sm bg-red-400 text-white px-4 py-2"
                                onClick={() => {
                                  if (item.quantity <= 1) {
                                    removeFromCart(item);
                                    return;
